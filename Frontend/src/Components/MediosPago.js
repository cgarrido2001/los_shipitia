  ...
  return (
    <div className="row p-md-5 m-0">
      <div className="col-sm-12 col-md-5 p-5 text-start text-white">
        <h1 className="mt-5"> Selecciona tu metodo</h1>
        <h1 className="mt-5"> de pago</h1>
      </div>
      ...
      <div className="col-sm-12 col-md-7 p-sm-5 p-md-2">
        <div className="card" style={{ background: "#1A1919" }}>
          <div className="row align-items-center">
            ...
            <button className="btn btn-danger col-2" type="button" style={{ height: "3vw", background: "#1A1919" }} onClick={(e) => MandaBanco()}>
              Ir al pago
            </button>
          </div>
        </div>
